...
export default function TabBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 md:hidden z-[5000] pb-safe bg-[var(--background)]/80 backdrop-blur-xl border-t border-[var(--border-color)]/50 will-change-transform isolate">
