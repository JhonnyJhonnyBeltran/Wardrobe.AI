        ...
        >
          ...
          <div className="p-5 sm:p-6 pb-4 border-b border-[var(--border-color)]/40 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={dismissTour}
                className="text-xs text-[var(--foreground-tertiary)] hover:text-[var(--foreground)] px-2 py-1 rounded-lg hover:bg-[var(--background-secondary)] transition-colors font-medium"
                title="Saltar tour"
              >
                Saltar tour
              </button>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 p-2.5 rounded-xl border text-left transition-all ${
                      isCur
                        ...
                        : isDone
                        ? 'bg-[var(--background-secondary)]/60 border-emerald-500/20 text-[var(--foreground-secondary)]'
      ...
      <AnimatePresence>
        {showCelebration && (
          <motion.div
            ...
            className="fixed bottom-20 left-1/2 -translate-x-1/2 z-[7000] w-[90vw] max-w-sm bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-2xl shadow-2xl p-4 flex items-center gap-3.5 border border-emerald-400/40"
          >
