                    ...
                    <AnimatePresence mode="wait">
                        {isResetPassword ? (
                            ...
                            <div className="mt-6 flex items-center justify-between">
                                ...
                                <span className="text-xs text-center text-[var(--foreground-secondary)] uppercase">o continuar con</span>
                                <span className="w-1/5 border-b border-[var(--border-color)]"></span>
                            </div>
                            ...
                            <div className="mt-6 flex flex-col sm:flex-row gap-3">
                                <button
                                    ...
                                    disabled={loading}
                                    className="w-full flex items-center justify-center gap-3 h-12 rounded-xl bg-[var(--background-secondary)] hover:bg-[var(--border-color)] text-[var(--foreground)] font-semibold transition-colors disabled:opacity-60 border border-[var(--border-color)]"
                                >
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className="hidden w-full items-center justify-center gap-3 h-12 rounded-xl bg-[var(--foreground)] hover:opacity-80 text-[var(--background)] font-semibold transition-colors disabled:opacity-60 border border-[var(--border-color)]"
                                >
                            ...
                            <div className="mt-8 text-center pt-2">
                                ...
                                <p className="text-[10px] text-[var(--foreground-tertiary)] mt-4 max-w-xs mx-auto leading-relaxed">
